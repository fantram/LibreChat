        ...
        buttons={
          <>
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded-lg border border-border-heavy bg-surface-secondary px-4 py-2 text-sm text-text-primary hover:bg-primary hover:text-white focus:bg-primary focus:text-white dark:hover:bg-primary dark:focus:bg-primary"
            >
